                    ...
                    success: function() // Success
                        {
                            ...
                            {
                                var successmsg = "Votre message a bien été envoyé.";
                    ...
                    error: function() // Fail
                        {
                            if ($('#form-alert').length == 0) {
                                var failmsg = "Il semblerait que notre serveur ne réponde pas. Veuillez nous excuser pour le désagrément et réessayer plus tard."
